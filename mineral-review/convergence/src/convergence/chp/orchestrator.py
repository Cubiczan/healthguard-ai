...
from convergence.chp.gates import evaluate_r0_gate
...
class CHPOrchestrator:
    """Orchestration layer for CHP-backed M&A integration decision sessions."""
    ...
    def run_initial_session(
        ...
        *,
        ...
        r0 = evaluate_r0_gate(
            ...
            worth_it=case.high_stakes or case.domain in self.INTEGRATION_DOMAINS,
        )
