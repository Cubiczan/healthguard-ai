...
class SessionStatus(str, Enum):
    ...
    REQUIRES_HUMAN = "REQUIRES_HUMAN_VERIFICATION"
    HALT = "HALT"
...
class WorkstreamType(str, Enum):
    ...
    CLOSE_HARMONIZATION = "close_harmonization"
    SYSTEMS_INTEGRATION = "systems_integration"
    SYNERGY_TRACKING = "synergy_tracking"
...
class DecisionCase:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DecisionCase":
        return cls(
            ...
            origin_system=data.get("origin_system", "convergence"),
